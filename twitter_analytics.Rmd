...
covid_exp <- rbind.data.frame(covid, wuhanvirus, chinavirus, flattenthecurve, moderna,
                              pfizer, socialdistancing, stayathome, coronavirus)
                              # covid19, vaccine, johnson
...
covid_exp1 <- c("covid", "wuhanvirus", "chinavirus", "flattenthecurve", "moderna",
                "pfizer", "socialdistancing", "stayathome", "vaccine") %>% 
